...
$string['autoassignrole'] = 'Assing role in sync_members';
$string['autoassignrole_help'] = 'When checked, will automatically assing a role (instructor or learner) to the enrolled user.';
